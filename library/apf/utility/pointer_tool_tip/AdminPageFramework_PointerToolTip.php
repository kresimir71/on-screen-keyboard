...
class OnScreenKeyboardAdminPageFramework_PointerToolTip extends OnScreenKeyboardAdminPageFramework_FrameworkUtility {
    ...
    {
        echo "<script type='text/javascript' class='on-screen-keyboard-pointer-tool-tip'>" . '/* <![CDATA[ */' . $this->___getInternalScript(self::$aPointers) . '/* ]]> */' . "</script>";
    }
