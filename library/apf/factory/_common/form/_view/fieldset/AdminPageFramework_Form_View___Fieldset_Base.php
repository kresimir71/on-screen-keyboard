...
abstract class OnScreenKeyboardAdminPageFramework_Form_View___Fieldset_Base extends OnScreenKeyboardAdminPageFramework_Form_Utility {
    ...
    {
        return $this->uniteArrays($aFieldset, $this->_getFieldTypeDefaultArguments($aFieldset[ 'type' ], $aFieldTypeDefinitions) + OnScreenKeyboardAdminPageFramework_Form_Model___Format_Fieldset::$aStructure);
    }
    ...
    protected function _getRepeatableFieldButtons($sFieldsContainerID, $iFieldCount, $aSettings)
    {
        ...
        $_oFormatter = new OnScreenKeyboardAdminPageFramework_Form_Model___Format_RepeatableField($_aSettings, $this->oMsg);
    ...
    {
        $_aContainerAttributes = array( 'class' => $this->getClassAttribute('on-screen-keyboard-repeatable-field-buttons', ! empty($aArguments[ 'disabled' ]) ? 'disabled' : ''), );
