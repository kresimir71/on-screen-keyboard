...
class OnScreenKeyboardAdminPageFramework_Form_View___Generate_FieldInputName extends OnScreenKeyboardAdminPageFramework_Form_View___Generate_FlatFieldName {
    public $sIndex = '';
