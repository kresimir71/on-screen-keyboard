...
class OnScreenKeyboardAdminPageFramework_Form_View___Attribute_SectionsTablesContainer extends OnScreenKeyboardAdminPageFramework_Form_View___Attribute_Base {
    ...
    private function _getDynamicElementArguments($aSectionset)
    {
        ...
        $_oSectionNameGenerator = new OnScreenKeyboardAdminPageFramework_Form_View___Generate_SectionName($aSectionset, $aSectionset[ '_caller_object' ]->aCallbacks[ 'hfSectionName' ]);
