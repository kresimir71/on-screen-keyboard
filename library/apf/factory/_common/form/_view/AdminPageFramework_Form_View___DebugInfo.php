...
class OnScreenKeyboardAdminPageFramework_Form_View___DebugInfo extends OnScreenKeyboardAdminPageFramework_FrameworkUtility {
    ...
    public function get()
    {
        ...
        return "<div class='on-screen-keyboard-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
