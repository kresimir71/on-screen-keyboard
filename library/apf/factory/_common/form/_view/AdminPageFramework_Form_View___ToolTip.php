...
class OnScreenKeyboardAdminPageFramework_Form_View___ToolTip extends OnScreenKeyboardAdminPageFramework_Form_View___Section_Base {
    ...
    public function get()
    {
        ...
        return "<span " . $this->___getElementAttributes('container', array( 'on-screen-keyboard-form-tooltip', 'no-js' ), $_aAttributes) . ">" . $this->___getTipIcon() . "<span " . $this->___getElementAttributes('content', 'on-screen-keyboard-form-tooltip-content') . ">" . $this->___getTipTitle() . $this->___getDescriptions() . "</span>" . "</span>" ;
    }
    ...
    private function ___getTipTitle()
    {
        if (isset($this->aArguments[ 'title' ])) {
            return "<span " . $this->___getElementAttributes('title', 'on-screen-keyboard-form-tooltip-title') . ">" . $this->aArguments[ 'title' ] . "</span>";
        }
        return '';
    }
    private function ___getDescriptions()
    {
        if (isset($this->aArguments[ 'content' ])) {
            return "<span " . $this->___getElementAttributes('description', 'on-screen-keyboard-form-tooltip-description') . ">" . implode("</span><span " . $this->___getElementAttributes('description', 'on-screen-keyboard-form-tooltip-description') . ">", $this->getAsArray($this->aArguments[ 'content' ])) . "</span>" ;
        }
        return '';
    }
