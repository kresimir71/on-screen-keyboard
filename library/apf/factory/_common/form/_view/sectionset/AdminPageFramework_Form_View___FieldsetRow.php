...
class OnScreenKeyboardAdminPageFramework_Form_View___FieldsetRow extends OnScreenKeyboardAdminPageFramework_Form_View___FieldsetTableRow {
    ...
    public function get()
    {
        ...
        $_oFieldrowAttribute = new OnScreenKeyboardAdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset);
