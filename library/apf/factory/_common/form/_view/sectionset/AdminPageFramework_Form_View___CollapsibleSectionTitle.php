...
class OnScreenKeyboardAdminPageFramework_Form_View___CollapsibleSectionTitle extends OnScreenKeyboardAdminPageFramework_Form_View___SectionTitle {
    ...
    private function ___enqueueScript()
    {
        ...
        $_oForm->addResource('src_scripts', array( 'handle_id' => 'on-screen-keyboard-script-form-collapsible-sections', ));
    }
    private function ___getCollapsibleSectionTitleBlock(array $aCollapsible, $sContainer='sections', $iSectionIndex=null)
    {
        ...
        return "<div " . $this->getAttributes(array( 'id' => $_sSectionTitleTagID, 'class' => $this->getClassAttribute('on-screen-keyboard-section-title', $this->getAOrB('box' === $aCollapsible[ 'type' ], 'accordion-section-title', ''), 'on-screen-keyboard-collapsible-title', $this->getAOrB('sections' === $aCollapsible[ 'container' ], 'on-screen-keyboard-collapsible-sections-title', 'on-screen-keyboard-collapsible-section-title'), $this->getAOrB($aCollapsible[ 'is_collapsed' ], 'collapsed', ''), 'on-screen-keyboard-collapsible-type-' . $aCollapsible[ 'type' ]), ) + $this->getDataAttributeArray($aCollapsible)) . ">" . $_sSectionTitle . "</div>";
    }
}
