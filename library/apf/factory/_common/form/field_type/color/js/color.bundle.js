...
(function ( $ ) {
  ...
  var apfColor = OnScreenKeyboardAdminPageFrameworkColorFieldType;

  var registerOnScreenKeyboardAdminPageFrameworkColorPickerField = function ( osSubjectInput, aOptions ) {
    ...
    var _aDefaults = {
      ...
      change: function ( event, ui ) {
        $( osTargetInput ).trigger( 'on-screen-keyboard_field_type_color_changed' );
      ...
      clear: function ( event, ui ) {
        $( osTargetInput ).trigger( 'on-screen-keyboard_field_type_color_cleared' );
  ...
  $( document ).ready( function () {
    ...
    // Initialization
    $( '.on-screen-keyboard-field-color-picker' ).each( function () {
      registerOnScreenKeyboardAdminPageFrameworkColorPickerField( $( this ).data( 'input_id' ) );
    } );
    ...
    $().registerOnScreenKeyboardAdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          oCloned.find( 'input.input_color' ).each( function ( iIterationIndex ) {
            ...
            registerOnScreenKeyboardAdminPageFrameworkColorPickerField( _oNewColorInput );
