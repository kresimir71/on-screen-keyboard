...
(function($){
  ...
  var apfTaxonomy = OnScreenKeyboardAdminPageFrameworkFieldTypeTaxonomy;
  ...
  $( document ).ready( function(){
    ...
    /* For tabs */
    var enableOnScreenKeyboardAdminPageFrameworkTabbedBox = function ( nodeTabBoxContainer ) {
    ...
    enableOnScreenKeyboardAdminPageFrameworkTabbedBox( $( '.tab-box-container' ) );
    ...
    $().registerOnScreenKeyboardAdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          // Initialize
          enableOnScreenKeyboardAdminPageFrameworkTabbedBox( oCloned.find( '.tab-box-container' ) );
