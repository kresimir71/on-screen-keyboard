...
class OnScreenKeyboardAdminPageFramework_FieldType_taxonomy extends OnScreenKeyboardAdminPageFramework_FieldType_checkbox {
    ...
    {
        return array( array( 'handle_id' => 'on-screen-keyboard-field-type-taxonomy', 'src' => dirname(__FILE__) . '/js/taxonomy.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', 'on-screen-keyboard-script-form-main' ), 'translation_var' => 'OnScreenKeyboardAdminPageFrameworkFieldTypeTaxonomy', 'translation' => array( 'fieldTypeSlugs' => $this->aFieldTypeSlugs, 'label' => array(), ), ), );
    }
