...
var apfImage = OnScreenKeyboardAdminPageFrameworkImageFieldType;
apfImage.hasMediaUploader = !! apfImage.hasMediaUploader;
(function ( $ ) {

  var setOnScreenKeyboardAdminPageFrameworkImageUploader;
  ...
  $( document ).ready( function () {
    ...
    if ( ! apfImage.hasMediaUploader ) {
       ...
       */
      setOnScreenKeyboardAdminPageFrameworkImageUploader = function ( sInputID, fMultiple, fExternalSource ) {
        ...
        _oSelectImage.on( 'click', function () {
          ...
          window.send_to_editor = hfOnScreenKeyboardAdminPageFrameworkSendToEditorImage;
      ...
      var hfOnScreenKeyboardAdminPageFrameworkSendToEditorImage = function ( sRawHTML ) {
      ...
      setOnScreenKeyboardAdminPageFrameworkImageUploader = function ( sInputID, fMultiple, fExternalSource ) {
        ...
        _oSelectImage.on( 'click', function ( e ) {
          ...
          oOnScreenKeyboardAdminPageFrameworkOriginalImageUploaderSelectObject = wp.media.view.MediaFrame.Select;
          // Assign a custom select object
          wp.media.view.MediaFrame.Select = fExternalSource ? getOnScreenKeyboardAdminPageFrameworkCustomMediaUploaderSelectObject() : oOnScreenKeyboardAdminPageFrameworkOriginalImageUploaderSelectObject;
          ...
          _oCustomImageUploader.on( 'close', function () {
            ...
            if ( typeof (_oImage) !== 'undefined' ) {
              ...
              _oCustomImageUploader.state().get( 'selection' ).each( function ( oAttachment, iIndex ) {
                ...
                var _oFieldContainer = 'undefined' === typeof _oNewField
                  ? $( '#' + sInputID ).closest( '.on-screen-keyboard-field' )
                  : _oNewField;
                _oNewField = $( this ).addOnScreenKeyboardAdminPageFrameworkRepeatableField( _oFieldContainer.attr( 'id' ) );
            ...
            wp.media.view.MediaFrame.Select = oOnScreenKeyboardAdminPageFrameworkOriginalImageUploaderSelectObject;
    ...
    $().registerOnScreenKeyboardAdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          // Bind the event.
          var _oFieldContainer = oCloned.closest( '.on-screen-keyboard-field' );
          ...
          setOnScreenKeyboardAdminPageFrameworkImageUploader(
    ...
    $( '.select_image.button' ).each( function() {
      setOnScreenKeyboardAdminPageFrameworkImageUploader( $( this ).data( 'input_id' ), $( this ).data( 'repeatable' ), $( this ).data( 'enable_external_source' ) );
    } );
    // Remove buttons
