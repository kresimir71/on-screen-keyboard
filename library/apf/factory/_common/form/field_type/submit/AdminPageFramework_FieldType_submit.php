...
class OnScreenKeyboardAdminPageFramework_FieldType_submit extends OnScreenKeyboardAdminPageFramework_FieldType {
    ...
    {
        return array( array( 'handle_id' => 'on-screen-keyboard-submit-field-type', 'src' => dirname(__FILE__) . '/js/submit.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', ), ), );
    }
    ...
    {
        return array( 'style' => $aField[ 'label_min_width' ] || '0' === ( string ) $aField[ 'label_min_width' ] ? "min-width:" . $this->getLengthSanitized($aField[ 'label_min_width' ]) . ";" : null, 'class' => 'on-screen-keyboard-input-label-container' . ' on-screen-keyboard-input-button-container' . ' on-screen-keyboard-input-container', );
    }
