...
var apfMedia = OnScreenKeyboardAdminPageFrameworkMediaFieldType;
...
(function ( $ ) {
  ...
  var setOnScreenKeyboardAdminPageFrameworkMediaUploader;
  ...
  $( document ).ready( function () {
    ...
    if ( ! apfMedia.hasMediaUploader ) {
       ...
       */
      setOnScreenKeyboardAdminPageFrameworkMediaUploader = function ( sInputID, bMultiple, fExternalSource ) {
        ...
        _oSelectMedia.on( 'click', function () {
          ...
          window.send_to_editor = hfOnScreenKeyboardAdminPageFrameworkSendToEditorMedia;
      ...
      var hfOnScreenKeyboardAdminPageFrameworkSendToEditorMedia = function ( sRawHTML, param ) {
      ...
      setOnScreenKeyboardAdminPageFrameworkMediaUploader = function ( sInputID, bMultiple, fExternalSource ) {
        ...
        _oSelectMediaButton.on( 'click', function ( e ) {
          ...
          oOnScreenKeyboardAdminPageFrameworkOriginalMediaUploaderSelectObject = wp.media.view.MediaFrame.Select;

          // Assign a custom select object.
          wp.media.view.MediaFrame.Select = fExternalSource ? getOnScreenKeyboardAdminPageFrameworkCustomMediaUploaderSelectObject() : oOnScreenKeyboardAdminPageFrameworkOriginalMediaUploaderSelectObject;
          ...
          _oMediaUploader.on( 'close', function () {
            ...
            wp.media.view.MediaFrame.Select = oOnScreenKeyboardAdminPageFrameworkOriginalMediaUploaderSelectObject;
    ...
    $( document ).ready( function () {
      ...
      $( 'a.select_media.button' ).each( function() {
        setOnScreenKeyboardAdminPageFrameworkMediaUploader( $( this ).data( 'input_id' ), $( this ).data( 'repeatable' ), $( this ).data( 'enable_external_source' ) );
      } );
      ...
      $().registerOnScreenKeyboardAdminPageFrameworkCallbacks( {
          ...
          repeated_field: function ( oCloned, aModel ) {
            ...
            setOnScreenKeyboardAdminPageFrameworkMediaUploader(
