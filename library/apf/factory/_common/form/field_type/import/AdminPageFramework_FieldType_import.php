...
class OnScreenKeyboardAdminPageFramework_FieldType_import extends OnScreenKeyboardAdminPageFramework_FieldType_submit {
    ...
    {
        return array( array( 'handle_id' => 'on-screen-keyboard-field-type-import', 'src' => dirname(__FILE__) . '/js/import.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', 'on-screen-keyboard-script-form-main' ), 'translation_var' => 'OnScreenKeyboardAdminPageFrameworkImportFieldType', 'translation' => array( 'fieldTypeSlugs' => $this->aFieldTypeSlugs, 'label' => array( 'noFile' => $this->oMsg->get('import_no_file'), ), ), ), );
    }
