...
( function( $ ){
  ...
  var apfRadio = OnScreenKeyboardAdminPageFrameworkFieldTypeRadio;
  ...
  $( document ).ready( function(){
    ...
    $( 'input[type=radio].on-screen-keyboard-input-radio' ).on( 'change', function ( e ) {

      var _sInputID = $( this ).data( 'id' );
      // Uncheck the other radio buttons
      $( this ).closest( '.on-screen-keyboard-field' ).find( 'input[type=radio][data-id="' + _sInputID + '"]' )
        .prop( 'checked', false )
        .attr( 'checked', false );
    ...
    $().registerOnScreenKeyboardAdminPageFrameworkCallbacks( {
        ...
        repeated_field: function( oCloned, aModel ) {
          oCloned.find( 'input[type=radio].on-screen-keyboard-input-radio' )
            .off( 'change' )
