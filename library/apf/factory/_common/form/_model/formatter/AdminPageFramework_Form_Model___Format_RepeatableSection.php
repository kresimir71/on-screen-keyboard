...
class OnScreenKeyboardAdminPageFramework_Form_Model___Format_RepeatableSection extends OnScreenKeyboardAdminPageFramework_FrameworkUtility {
    ...
    public function __construct()
    {
        ...
        $this->_oMsg = $_aParameters[ 1 ] ? $_aParameters[ 1 ] : OnScreenKeyboardAdminPageFramework_Message::getInstance();
    }
    public function get()
    {
