...
class OnScreenKeyboardAdminPageFramework_Form_Model___FormatSectionset extends OnScreenKeyboardAdminPageFramework_Form_Utility {
    ...
    public function get()
    {
        ...
        $_oCollapsibleArgumentFormatter = new OnScreenKeyboardAdminPageFramework_Form_Model___Format_CollapsibleSection($_aSectionset[ 'collapsible' ], $_aSectionset[ 'title' ]);
