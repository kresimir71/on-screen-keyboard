...
abstract class OnScreenKeyboardAdminPageFramework_Input_Base extends OnScreenKeyboardAdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array( 'input_container_tag' => 'span', 'input_container_attributes' => array( 'class' => 'on-screen-keyboard-input-container', ), 'label_container_tag' => 'span', 'label_container_attributes' => array( 'class' => 'on-screen-keyboard-input-label-string', ), );
