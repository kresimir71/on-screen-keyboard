...
class OnScreenKeyboardAdminPageFramework_Form___SubmitNotice extends OnScreenKeyboardAdminPageFramework_FrameworkUtility {
    ...
    {
        new OnScreenKeyboardAdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices)
    {
        ...
        foreach (array_filter(( array ) $aNotices, 'is_array') as $_aNotice) {
            ...
            new OnScreenKeyboardAdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
}
