...
class OnScreenKeyboardAdminPageFramework_Debug extends OnScreenKeyboardAdminPageFramework_Debug_Log {
    ...
    {
        self::showDeprecationNotice('OnScreenKeyboardAdminPageFramework_Debug::' . __FUNCTION__, 'OnScreenKeyboardAdminPageFramework_Debug::dump()');
        OnScreenKeyboardAdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    public static function getArray($asArray, $sFilePath=null, $bEscape=true)
    {
        self::showDeprecationNotice('OnScreenKeyboardAdminPageFramework_Debug::' . __FUNCTION__, 'OnScreenKeyboardAdminPageFramework_Debug::get()');
        return OnScreenKeyboardAdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    public static function logArray($asArray, $sFilePath=null)
    {
        self::showDeprecationNotice('OnScreenKeyboardAdminPageFramework_Debug::' . __FUNCTION__, 'OnScreenKeyboardAdminPageFramework_Debug::log()');
        OnScreenKeyboardAdminPageFramework_Debug::log($asArray, $sFilePath);
    }
}
