...
class OnScreenKeyboardAdminPageFramework_FrameworkUtility extends OnScreenKeyboardAdminPageFramework_WPUtility {
    ...
    {
        $_sVersion = OnScreenKeyboardAdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    public static function getFrameworkName()
    {
        return OnScreenKeyboardAdminPageFramework_Registry::NAME;
    }
