...
abstract class OnScreenKeyboardAdminPageFramework_Factory_View extends OnScreenKeyboardAdminPageFramework_Factory_Model {
    public function __construct($oProp)
    {
        parent::__construct($oProp);
        new OnScreenKeyboardAdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
