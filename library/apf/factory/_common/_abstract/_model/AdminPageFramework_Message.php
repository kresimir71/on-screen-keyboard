 ...
 *
 * http://on-screen-keyboard.michaeluno.jp/
 ...
 * @package  OnScreenKeyboardAdminPageFramework/Common/Factory/Property
 * @internal
 ...
 */
class OnScreenKeyboardAdminPageFramework_Message {
     ...
     *      'foo'  => __( 'Foo', 'on-screen-keyboard' ),
     *      'bar'  => __( 'Bar', 'on-screen-keyboard' ),
     *       ... more 100 items
     * )
    ...
    public $aDefaults = array(
        ...
        // OnScreenKeyboardAdminPageFramework
        ...
        // OnScreenKeyboardAdminPageFramework_PostType
        'title'                                 => 'Title',
        'author'                                => 'Author',
        ...
        // OnScreenKeyboardAdminPageFramework_Link_Base
        'powered_by'                            => 'Thank you for creating with',
        'and'                                   => 'and',

        // OnScreenKeyboardAdminPageFramework_Link_admin_page
        'settings'                              => 'Settings',

        // OnScreenKeyboardAdminPageFramework_Link_post_type
        'manage'                                => 'Manage',

        // OnScreenKeyboardAdminPageFramework_FieldType_{...}
        ...
        // OnScreenKeyboardAdminPageFramework_Form_View___Script_{...}
        'select'                                => 'Select', // 3.4.2+
        'insert'                                => 'Insert',  // 3.4.2+
        'use_this'                              => 'Use This', // 3.4.2+
        'return_to_library'                     => 'Return to Library', // 3.4.2+

        // OnScreenKeyboardAdminPageFramework_PageLoadInfo_Base
        ...
        // OnScreenKeyboardAdminPageFramework_FormField
        ...
        // OnScreenKeyboardAdminPageFramework_FormPart_Table
        ...
        // OnScreenKeyboardAdminPageFramework_FieldType_reset 3.3.0+
        'reset'                                 => 'Reset',

        // OnScreenKeyboardAdminPageFramework_FieldType_system 3.5.3+
        'yes'                                   => 'Yes',
        'no'                                    => 'No',
        'on'                                    => 'On',
        'off'                                   => 'Off',
        ...
        // 3.7.0+ - accessed from `OnScreenKeyboardAdminPageFramework_Form`
        'method_called_too_early'               => 'The method is called too early.',

        // 3.7.0+  - accessed from `OnScreenKeyboardAdminPageFramework_Form_View___DebugInfo`
     ...
     */
    protected $_sTextDomain = 'on-screen-keyboard';
     ...
     * @return      OnScreenKeyboardAdminPageFramework_Message
     */
    public static function getInstance( $sTextDomain='on-screen-keyboard' ) {

        $_oInstance = isset( self::$_aInstancesByTextDomain[ $sTextDomain ] ) && ( self::$_aInstancesByTextDomain[ $sTextDomain ] instanceof OnScreenKeyboardAdminPageFramework_Message )
            ? self::$_aInstancesByTextDomain[ $sTextDomain ]
            : new OnScreenKeyboardAdminPageFramework_Message( $sTextDomain );
         ...
         * @deprecated  3.2.0
         */
        public static function instantiate( $sTextDomain='on-screen-keyboard' ) {
     ...
     * @param string $sTextDomain
     */
    public function __construct( $sTextDomain='on-screen-keyboard' ) {
    ...
    private function ___doDummy() {
        ...
        __( 'The options have been updated.', 'on-screen-keyboard' );
        __( 'The options have been cleared.', 'on-screen-keyboard' );
        __( 'Export', 'on-screen-keyboard' );
        __( 'Export Options', 'on-screen-keyboard' );
        __( 'Import', 'on-screen-keyboard' );
        __( 'Import Options', 'on-screen-keyboard' );
        __( 'Submit', 'on-screen-keyboard' );
        __( 'An error occurred while uploading the import file.', 'on-screen-keyboard' );
        /* translators: 1: Uploaded file type */
        __( 'The uploaded file type is not supported: %1$s', 'on-screen-keyboard' );
        __( 'Could not load the importing data.', 'on-screen-keyboard' );
        __( 'The uploaded file has been imported.', 'on-screen-keyboard' );
        __( 'No data could be imported.', 'on-screen-keyboard' );
        __( 'Upload Image', 'on-screen-keyboard' );
        __( 'Use This Image', 'on-screen-keyboard' );
        __( 'Insert from URL', 'on-screen-keyboard' );
        __( 'Are you sure you want to reset the options?', 'on-screen-keyboard' );
        __( 'Please confirm your action.', 'on-screen-keyboard' );
        __( 'The specified options have been deleted.', 'on-screen-keyboard' );
        __( 'A problem occurred while processing the form data. Please try again.', 'on-screen-keyboard' );
        /* translators: 1: The value of max_input_vars set by PHP 2: Actual $_POST element count */
        __( 'Not all form fields could not be sent. Please check your server settings of PHP <code>max_input_vars</code> and consult the server administrator to increase the value. <code>max input vars</code>: %1$s. <code>$_POST</code> count: %2$s', 'on-screen-keyboard' ); // sanitization unnecessary as a literal string
        __( 'Is it okay to send the email?', 'on-screen-keyboard' );
        __( 'The email has been sent.', 'on-screen-keyboard' );
        __( 'The email has been scheduled.', 'on-screen-keyboard' );
        __( 'There was a problem sending the email', 'on-screen-keyboard' );
        __( 'Title', 'on-screen-keyboard' );
        __( 'Author', 'on-screen-keyboard' );
        __( 'Categories', 'on-screen-keyboard' );
        __( 'Tags', 'on-screen-keyboard' );
        __( 'Comments', 'on-screen-keyboard' );
        __( 'Date', 'on-screen-keyboard' );
        __( 'Show All', 'on-screen-keyboard' );
        __( 'Show All Authors', 'on-screen-keyboard' );
        __( 'Thank you for creating with', 'on-screen-keyboard' );
        __( 'and', 'on-screen-keyboard' );
        __( 'Settings', 'on-screen-keyboard' );
        __( 'Manage', 'on-screen-keyboard' );
        __( 'Select Image', 'on-screen-keyboard' );
        __( 'Upload File', 'on-screen-keyboard' );
        __( 'Use This File', 'on-screen-keyboard' );
        __( 'Select File', 'on-screen-keyboard' );
        __( 'Remove Value', 'on-screen-keyboard' );
        __( 'Select All', 'on-screen-keyboard' );
        __( 'Select None', 'on-screen-keyboard' );
        __( 'No term found.', 'on-screen-keyboard' );
        __( 'Select', 'on-screen-keyboard' );
        __( 'Insert', 'on-screen-keyboard' );
        __( 'Use This', 'on-screen-keyboard' );
        __( 'Return to Library', 'on-screen-keyboard' );
        /* translators: 1: Number of performed database queries 2: Elapsed seconds for page load */
        __( '%1$s queries in %2$s seconds.', 'on-screen-keyboard' );
        /* translators: 1: Used memory amount 2: Max memory cap set by WordPress (WP_MEMORY_LIMIT) 3: Percentage of the memory usage */
        __( '%1$s out of %2$s MB (%3$s) memory used.', 'on-screen-keyboard' );
        /* translators: 1: Peak memory usage amount */
        __( 'Peak memory usage %1$s MB.', 'on-screen-keyboard' );
        /* translators: 1: Initial memory usage amount */
        __( 'Initial memory usage  %1$s MB.', 'on-screen-keyboard' );
        __( 'The allowed maximum number of fields is {0}.', 'on-screen-keyboard' );
        __( 'The allowed minimum number of fields is {0}.', 'on-screen-keyboard' );
        __( 'Add', 'on-screen-keyboard' );
        __( 'Remove', 'on-screen-keyboard' );
        __( 'The allowed maximum number of sections is {0}', 'on-screen-keyboard' );
        __( 'The allowed minimum number of sections is {0}', 'on-screen-keyboard' );
        __( 'Add Section', 'on-screen-keyboard' );
        __( 'Remove Section', 'on-screen-keyboard' );
        __( 'Toggle All', 'on-screen-keyboard' );
        __( 'Toggle all collapsible sections', 'on-screen-keyboard' );
        __( 'Reset', 'on-screen-keyboard' );
        __( 'Yes', 'on-screen-keyboard' );
        __( 'No', 'on-screen-keyboard' );
        __( 'On', 'on-screen-keyboard' );
        __( 'Off', 'on-screen-keyboard' );
        __( 'Enabled', 'on-screen-keyboard' );
        __( 'Disabled', 'on-screen-keyboard' );
        __( 'Supported', 'on-screen-keyboard' );
        __( 'Not Supported', 'on-screen-keyboard' );
        __( 'Functional', 'on-screen-keyboard' );
        __( 'Not Functional', 'on-screen-keyboard' );
        __( 'Too Long', 'on-screen-keyboard' );
        __( 'Acceptable', 'on-screen-keyboard' );
        __( 'No log found.', 'on-screen-keyboard' );

        /* translators: 1: Method name */
        __( 'The method is called too early: %1$s', 'on-screen-keyboard' );
        __( 'Debug Info', 'on-screen-keyboard' );

        __( 'Click here to expand to view the contents.', 'on-screen-keyboard' );
        __( 'Click here to collapse the contents.', 'on-screen-keyboard' );

        __( 'Loading...', 'on-screen-keyboard' );
        __( 'Please enable JavaScript for better user experience.', 'on-screen-keyboard' );

        __( 'Debug', 'on-screen-keyboard' );
        // __( 'Field Arguments', 'on-screen-keyboard' ); @deprecated 3.8.22
        __( 'This information will be disabled when <code>WP_DEBUG</code> is set to <code>false</code> in <code>wp-config.php</code>.', 'on-screen-keyboard' );

        // __( 'Section Arguments', 'on-screen-keyboard' ); // 3.8.8+ @deprecated 3.8.22

        __( 'The ability to repeat sections is disabled.', 'on-screen-keyboard' ); // 3.8.13+
        __( 'The ability to repeat fields is disabled.', 'on-screen-keyboard' ); // 3.8.13+
        __( 'Warning.', 'on-screen-keyboard' ); // 3.8.13+

        __( 'Submit the form.', 'on-screen-keyboard' ); // 3.8.24
        __( 'Please check this box if you want to proceed.', 'on-screen-keyboard' ); // 3.8.24
        __( 'No file is selected.', 'on-screen-keyboard' ); // 3.8.24

        __( 'Please fill out this field.', 'on-screen-keyboard' ); // 3.9.0
