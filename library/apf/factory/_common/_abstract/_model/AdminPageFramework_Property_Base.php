...
abstract class OnScreenKeyboardAdminPageFramework_Property_Base extends OnScreenKeyboardAdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType)
    {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'on-screen-keyboard' : $sTextDomain;
    ...
    {
        if (! isset($GLOBALS[ 'aOnScreenKeyboardAdminPageFramework' ])) {
            $GLOBALS[ 'aOnScreenKeyboardAdminPageFramework' ] = array( 'aFieldFlags' => array() );
        }
    }
    ...
    {
        self::$_aLibraryData = array( 'sName' => OnScreenKeyboardAdminPageFramework_Registry::NAME, 'sURI' => OnScreenKeyboardAdminPageFramework_Registry::URI, 'sScriptName' => OnScreenKeyboardAdminPageFramework_Registry::NAME, 'sLibraryName' => OnScreenKeyboardAdminPageFramework_Registry::NAME, 'sLibraryURI' => OnScreenKeyboardAdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => OnScreenKeyboardAdminPageFramework_Registry::getVersion(), 'sDescription' => OnScreenKeyboardAdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => OnScreenKeyboardAdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => OnScreenKeyboardAdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => OnScreenKeyboardAdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => OnScreenKeyboardAdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '', );
    ...
    public function __get($sName)
    {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new OnScreenKeyboardAdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
