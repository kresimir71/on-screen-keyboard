...
abstract class OnScreenKeyboardAdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array( 'oForm' => 'OnScreenKeyboardAdminPageFramework_Form_', 'oPageLoadInfo' => 'OnScreenKeyboardAdminPageFramework_PageLoadInfo_', 'oResource' => 'OnScreenKeyboardAdminPageFramework_Resource_', 'oHelpPane' => 'OnScreenKeyboardAdminPageFramework_HelpPane_', 'oLink' => 'OnScreenKeyboardAdminPageFramework_Link_', );
    private $_aSubClassNames = array( 'oProp' => null, 'oDebug' => 'OnScreenKeyboardAdminPageFramework_Debug', 'oUtil' => 'OnScreenKeyboardAdminPageFramework_FrameworkUtility', 'oMsg' => 'OnScreenKeyboardAdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null, );
    ...
    {
        trigger_error(OnScreenKeyboardAdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString()
    {
        return OnScreenKeyboardAdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
