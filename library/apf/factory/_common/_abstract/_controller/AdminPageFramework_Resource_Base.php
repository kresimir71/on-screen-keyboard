...
abstract class OnScreenKeyboardAdminPageFramework_Resource_Base extends OnScreenKeyboardAdminPageFramework_FrameworkUtility {
    ...
    protected $_sClassSelector_Style = 'on-screen-keyboard-style';
    protected $_sClassSelector_Script = 'on-screen-keyboard-script';
    ...
    {
        $_sStyleIE = $this->addAndApplyFilters($oCaller, array( "style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}", ), OnScreenKeyboardAdminPageFramework_CSS::getDefaultCSSIE());
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName)
    {
        ...
        $_sScript = $this->addAndApplyFilters($this->oProp->oCaller, array( "script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}", ), OnScreenKeyboardAdminPageFramework_Property_Base::$_sDefaultScript);
    ...
    public function _replyToAddStyle()
    {
        ...
        $this->_printCommonStyles('on-screen-keyboard-style-common', get_class());
    ...
    public function _replyToAddScript()
    {
        ...
        $this->_printCommonScripts('on-screen-keyboard-script-common', get_class());
    ...
    public function _replyToEnqueueCommonStyles()
    {
        ...
        $this->_addEnqueuingResourceByType(OnScreenKeyboardAdminPageFramework_Registry::$sDirPath . '/factory/_common/asset/css/common.css', array( 'version' => OnScreenKeyboardAdminPageFramework_Registry::VERSION, ), 'style');
    }
