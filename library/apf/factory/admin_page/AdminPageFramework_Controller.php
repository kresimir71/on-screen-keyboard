...
abstract class OnScreenKeyboardAdminPageFramework_Controller extends OnScreenKeyboardAdminPageFramework_View {
    ...
    public function setAdminNotice($sMessage, $sClassSelector='error', $sID='')
    {
        ...
        new OnScreenKeyboardAdminPageFramework_AdminNotice($this->oProp->aAdminNotices[ $sID ][ 'sMessage' ], $this->oProp->aAdminNotices[ $sID ][ 'aAttributes' ], array( 'should_show' => array( $this, 'isInThePage' ), ));
    }
    ...
    {
        return OnScreenKeyboardAdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
    }
}
