...
class OnScreenKeyboardAdminPageFramework_Property_admin_page extends OnScreenKeyboardAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability='manage_options', $sTextDomain='on-screen-keyboard')
    {
        ...
        $GLOBALS[ 'aOnScreenKeyboardAdminPageFramework' ][ 'aPageClasses' ] = $this->getElementAsArray($GLOBALS, array( 'aOnScreenKeyboardAdminPageFramework', 'aPageClasses' ));
        $GLOBALS[ 'aOnScreenKeyboardAdminPageFramework' ][ 'aPageClasses' ][ $sClassName ] = $oCaller;
