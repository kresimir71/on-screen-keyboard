...
class OnScreenKeyboardAdminPageFramework_Model__FormSubmission__Validator__Import extends OnScreenKeyboardAdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    {
        $_oImport = new OnScreenKeyboardAdminPageFramework_ImportOptions($this->getHTTPRequestSanitized($_FILES[ '__import' ], false), $this->getHTTPRequestSanitized($_POST[ '__import' ]));
