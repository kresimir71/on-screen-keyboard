...
class OnScreenKeyboardAdminPageFramework_Model__FormSubmission__Validator__Filter extends OnScreenKeyboardAdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
