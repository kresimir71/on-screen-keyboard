...
class OnScreenKeyboardAdminPageFramework_Model__FormSubmission__Validator extends OnScreenKeyboardAdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory)
    {
        ...
        $_aClassNames = array( 'OnScreenKeyboardAdminPageFramework_Model__FormSubmission__Validator__Link', 'OnScreenKeyboardAdminPageFramework_Model__FormSubmission__Validator__Redirect', 'OnScreenKeyboardAdminPageFramework_Model__FormSubmission__Validator__Import', 'OnScreenKeyboardAdminPageFramework_Model__FormSubmission__Validator__Export', 'OnScreenKeyboardAdminPageFramework_Model__FormSubmission__Validator__Reset', 'OnScreenKeyboardAdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'OnScreenKeyboardAdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'OnScreenKeyboardAdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm', );
        ...
        try {
            ...
            $_oFormSubmissionFilter = new OnScreenKeyboardAdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
