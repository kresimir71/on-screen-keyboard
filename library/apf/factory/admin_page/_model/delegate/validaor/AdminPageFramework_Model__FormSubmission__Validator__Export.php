...
class OnScreenKeyboardAdminPageFramework_Model__FormSubmission__Validator__Export extends OnScreenKeyboardAdminPageFramework_Model__FormSubmission__Validator__Import {
    ...
    {
        $_oExport = new OnScreenKeyboardAdminPageFramework_ExportOptions($this->getHTTPRequestSanitized($this->getElementAsArray($_POST, array( '__export' ))), $this->oFactory->oProp->sClassName);
