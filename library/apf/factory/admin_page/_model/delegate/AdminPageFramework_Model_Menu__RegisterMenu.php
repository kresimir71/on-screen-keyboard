...
class OnScreenKeyboardAdminPageFramework_Model_Menu__RegisterMenu extends OnScreenKeyboardAdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    public function _replyToRegisterSubMenuItems()
    {
        ...
        foreach ($_aPages as $_aSubMenuItem) {
            $_oFormatter = new OnScreenKeyboardAdminPageFramework_Format_SubMenuItem($_aSubMenuItem, $this->oFactory, ++$_iParsedIndex);
