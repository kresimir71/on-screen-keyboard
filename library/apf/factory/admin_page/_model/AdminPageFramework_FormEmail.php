...
class OnScreenKeyboardAdminPageFramework_FormEmail extends OnScreenKeyboardAdminPageFramework_FrameworkUtility {
    ...
    public function send()
    {
        ...
        do_action('on-screen-keyboard_action_before_sending_form_email', $_aEmailOptions, $_aInputs, $_sSubmitSectionID);
        ...
        do_action('on-screen-keyboard_action_after_sending_form_email', $_bSent, $_aEmailOptions);
