...
class OnScreenKeyboardAdminPageFramework_View__Resource extends OnScreenKeyboardAdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    {
        $_oFormatter = new OnScreenKeyboardAdminPageFramework_Format_PageResource_Style($asPageStyle);
    ...
    {
        $_oFormatter = new OnScreenKeyboardAdminPageFramework_Format_PageResource_Script($asPageScript);
