...
class OnScreenKeyboardAdminPageFramework_View__PageRenderer__PageHeadingTabs extends OnScreenKeyboardAdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTag = 'h2';
    ...
    {
        $_oTabBar = new OnScreenKeyboardAdminPageFramework_TabNavigationBar($aPages, $sCurrentPageSlug, $sTag, array( ), array( 'format' => array( $this, '_replyToFormatNavigationTabItem_PageHeadingTab' ), ));
        $_sTabBar = $_oTabBar->get();
        return $_sTabBar ? "<div class='on-screen-keyboard-page-heading-tab'>" . $_sTabBar . "</div>" : '';
    }
