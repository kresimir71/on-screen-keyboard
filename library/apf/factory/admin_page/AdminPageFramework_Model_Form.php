...
abstract class OnScreenKeyboardAdminPageFramework_Model_Form extends OnScreenKeyboardAdminPageFramework_Router {
    public $aFieldErrors;
    ...
    {
        new OnScreenKeyboardAdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
    }
