...
abstract class OnScreenKeyboardAdminPageFramework_Router extends OnScreenKeyboardAdminPageFramework_Factory {
    public $oProp;
    public $oForm;
    public function __construct($sOptionKey=null, $sCallerPath=null, $sCapability='manage_options', $sTextDomain='on-screen-keyboard')
    {
        $_sPropertyClassName = isset($this->aSubClassNames[ 'oProp' ]) ? $this->aSubClassNames[ 'oProp' ] : 'OnScreenKeyboardAdminPageFramework_Property_' . $this->_sStructureType;
    ...
    public function _replyToLoadComponentsForAjax()
    {
        ...
        new OnScreenKeyboardAdminPageFramework_Model_Menu__RegisterMenu($this, 'pseudo_admin_menu');
